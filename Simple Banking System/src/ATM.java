...
public class ATM {
	...
	public static void showTransactionHistory(User theUser, Scanner sc) {
		...
		do {
			...
			if (theAcct < 0 || theAcct >= theUser.numAccounts()) {
				System.out.println("No such account exists! what is wrong with you?");
			}
	...
	public static void transferFunds(User theUser, Scanner sc) {
		...
		do {
			...
			if (fromAcct < 0 || fromAcct >= theUser.numAccounts()) {
				System.out.println("No such account exists!!! Imma whoop yo ass!");
			}
		...
		do {
			...
			if (amount < 0) {
				System.out.println("The amount to transfer cannot be negativge, Man Fuck you!");
			}else if(amount > acctBal) {
				System.out.println("Transfer amount exceeded!, you aint got that much money in yo account");
			}
	...
	public static void withdrawFunds(User theUser, Scanner sc) {
		...
		do {
			...
			amount = sc.nextDouble();
			if (amount < 0) {
				System.out.println("The amount to withdraw cannot be negativge, Man Fuck you!");
			}else if(amount > acctBal) {
				System.out.println("Withdraw amount exceeded!, you aint got that much money in yo account");
			}
		}while(amount < 0 || amount > acctBal);		
		...
		//get the memo
		System.out.print("Enter memo if ya want :");
		memo = sc.nextLine();
	...
	public static void depositFunds(User theUser, Scanner sc) {
		...
		do {
			...
			amount = sc.nextDouble();
			if (amount < 0) {
				System.out.println("The amount to deposit cannot be negativge, Man Fuck you!");
			}
		}while(amount < 0);		
